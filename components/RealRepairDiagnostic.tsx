        ...
        <div className="flex gap-4">
           {!allRepaired && (
             <button 
               ...
               className="bg-brandRed/10 border border-brandRed text-brandRed px-6 py-2 text-[10px] font-black uppercase tracking-widest hover:bg-brandRed hover:text-white transition-all shadow-[0_0_15px_rgba(204,0,1,0.2)]"
             >
               Bulk_Restore
             </button>
           )}
